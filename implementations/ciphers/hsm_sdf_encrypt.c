...
#include "hsm_sdf_encrypt.h"
#include "prov/implementations.h"
#include "prov/providercommon.h"
#include "prov/provider_ctx.h"
#include "prov/piico_define.h"
#include <string.h>
//#include "prov/sdfStruct.h"
...
static void cleanup(void* hDevice, void* hSession, void* hKey,
    ...
    if (ciphertext) {
        free(ciphertext);
        printf("Ciphertext memory freed.\n");
    }
    if (decryptedtext) {
        free(decryptedtext);
        printf("Decryptedtext memory freed.\n");
    }
...
static void* hsm_newctx(void* provctx) {
...
static int hsm_update(void* vctx, unsigned char* out,
